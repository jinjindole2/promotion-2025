package com.jinjindole2.jinpro.promotion.domain.repository
...
interface PromotionJoinTypeDomainRepository {
     ...
     * 특정 참여 타입 조회
     */
    suspend fun findBypromoIdAndJoinType(promoId: Long, joinType: com.jinjindole2.jinpro.promotion.domain.model.JoinType): PromotionJoinType?
}